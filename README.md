...
## Environments
- Preview: https://main--ue-workshop-repo--lovelymandal16.hlx.page/
- Live: https://main--ue-workshop-repo--lovelymandal16.hlx.live/
...
1. Open the `ue-workshop-repo` directory in your favorite IDE and start coding :)
